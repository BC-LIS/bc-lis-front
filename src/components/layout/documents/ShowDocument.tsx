        ...
        {loading ? (
          ...
          <div className="flex flex-col space-y-8 p-2 mt-2">
            ...
            <div className="flex flex-col gap-2 text-sm sm:text-base">
              ...
              <h1 className="text-2xl text-center mt-2">Contenido</h1>
              <article
                dangerouslySetInnerHTML={{ __html: document.content || "" }}
                className="text-sm sm:text-base text-justify whitespace-pre-line border border-accent-foreground p-4 rounded-lg shadow-sm"
              ></article>
            </div>
          </div>
        )}
